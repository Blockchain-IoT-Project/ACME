...
public class Config {
	...
	public static final String ORG1_USR_BASE_PATH = ".." + File.separator + "network" + File.separator + "crypto-config" + File.separator + "peerOrganizations" + File.separator
			+ "org1.acme.org" + File.separator + "users" + File.separator + "Admin@org1.acme.org"
			+ File.separator + "msp";
	
	public static final String ORG2_USR_BASE_PATH = ".." + File.separator + "network" + File.separator + "crypto-config" + File.separator + "peerOrganizations" + File.separator
			+ "org2.acme.org" + File.separator + "users" + File.separator + "Admin@org2.acme.org"
			+ File.separator + "msp";
	
	public static final String ORG1_USR_ADMIN_PK = ORG1_USR_BASE_PATH + File.separator + "keystore";
	public static final String ORG1_USR_ADMIN_CERT = ORG1_USR_BASE_PATH + File.separator + "signcerts"; //used to be admincerts
